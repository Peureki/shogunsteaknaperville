<template>
    ...
    <section class="grid-container" id="grid-menu">
        ...
        <Polaroid
            ...
            :src="Onion1"
            alt="Onion volcano on fire on a grill"
            title="Onion volcano"
        />
